...
fun ForgotPasswordScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Crossfade(targetState = uiState.resetEmailSent, animationSpec = tween(150)) { emailSent ->
            if (emailSent) {
                ...
                Text(
                    text = "We've sent a password reset link to your email. Check your inbox and follow the instructions.",
